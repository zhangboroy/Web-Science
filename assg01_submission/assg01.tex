\documentclass{article}
	...
	\begin{document}
		...
		\textbf{HTML response:}\\
			...
			$<$/html$>$\\\\
		\textbf{Screen shot:}\\
		\fbox{\includegraphics[width=1.2\textwidth]{response.jpg}}\\\\
		...
		\fbox{\includegraphics[width=1\textwidth]{result01.jpg}}\\\\
		\indent2. http://www.cs.odu.edu/\~{}mln/\\
		\fbox{\includegraphics[width=1\textwidth]{result02.jpg}}\\\\
		\indent3. http://www.cs.odu.edu/\~{}mln/teaching/\\
		\fbox{\includegraphics[width=1\textwidth]{result03.jpg}}\\\\\\
